...
```javascript
import isConfigurablePropertyIn from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-configurable-property-in@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-configurable-property-in/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/assert-is-configurable-property-in/actions/workflows/test.yml?query=branch:v0.2.1
